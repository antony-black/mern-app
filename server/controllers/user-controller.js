...
class UserController {
  async registration(req, res, next) {
    try {
      ...
      if (!errors.isEmpty()) {
        return next(ApiError.BadRequest('UserController/registration: validation error!', errors.array()));
      }
  ...
  async activate(req, res, next) {
    try {
      ...
      console.error("UserController/activate: ", error.message);
      next(error);
    }
  }
  ...
  async refresh(req, res, next) {
    try {
      ...
      console.error("UserController/refresh: ", error.message);
      next(error);
    }
  }
